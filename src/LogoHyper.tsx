...
const LogoHyper = forwardRef<SVGSVGElement, IconProps>(
    ...
    return (
      ...
      >
        ...
        <g clipPath="url(#clip0_872_3189)">
                                  <rect x="0.75" y="0.75" width="14.5" height="14.5" rx="3.25" fill="black" stroke="url(#paint0_linear_872_3189)" strokeWidth="1.5"></rect>
