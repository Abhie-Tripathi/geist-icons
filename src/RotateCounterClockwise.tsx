...
const RotateCounterClockwise: React.FC<AccessibilityProps> = (props) => {
  return (
    <SvgContainer
      height={props.height}
      width={props.width}
...
RotateCounterClockwise.defaultProps = {
  // style
  style: {},
  color: '#000000',
  height: '22px',
